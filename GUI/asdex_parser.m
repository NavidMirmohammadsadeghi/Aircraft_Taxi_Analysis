...
input_directory='C:\OnGoing Projects\DATA for Individual Runs\ASDEX\IAH+ASDEX\2015\201507\20150716';
% Open input file
...
%             PDARS(FlightCounter).Track.recTime_Formatted_Time(TrackRecord) = {Actual_Hours_Formatted};
            ...
            if abs(PDARS(FlightCounter).Track.alt(1)-Average_alt)<=0.1*PDARS(FlightCounter).Track.alt(1)
